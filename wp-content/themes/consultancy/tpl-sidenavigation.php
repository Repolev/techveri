...
get_header();
	...
	if( array_key_exists('sidenav-align', $tpl_default_settings) && $tpl_default_settings['sidenav-align'] == 'true' ) {
		$page_layout .= ' sidenav-alignright';
	}

	if( array_key_exists('sidenav-sticky', $tpl_default_settings) && $tpl_default_settings['sidenav-sticky'] == 'true' ) {
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout ); ?>">
        ...
        <div class="side-navigation">
			...
			// Side Nav Content
			if( array_key_exists('enable-sidenav-content', $tpl_default_settings) && $tpl_default_settings['enable-sidenav-content'] == 'true' ) :
				$hook = $tpl_default_settings['sidenav-content'];
