...
<div id="buddypress">
	...
	<div class="dt-sc-group-container">
        <div id="item-nav">
            <div class="item-list-tabs no-ajax" id="object-nav" aria-label="<?php esc_attr_e( 'Group primary navigation', 'consultancy' ); ?>" role="navigation">
                <ul>
