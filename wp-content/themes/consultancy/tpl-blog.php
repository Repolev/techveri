...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout ); ?>"><?php
        ...
        $tpl_default_settings['blog-post-excerpt'] = isset($tpl_default_settings['blog-post-excerpt']) ? $tpl_default_settings['blog-post-excerpt'] : '';
        $tpl_default_settings['enable-blog-readmore'] =  isset($tpl_default_settings['enable-blog-readmore']) ? $tpl_default_settings['enable-blog-readmore'] : '';
        $tpl_default_settings['show-date-info'] = isset($tpl_default_settings['show-date-info']) ? $tpl_default_settings['show-date-info'] : '';
        $tpl_default_settings['show-author-info'] = isset($tpl_default_settings['show-author-info'] ) ? $tpl_default_settings['show-author-info'] : '';        
                        ...
                        <?php if( $format == "image" || empty($format) ) :
                                if( has_post_thumbnail() ) :?>
                                    <div class="entry-thumb">
                                        <a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s','consultancy'),the_title_attribute('echo=0')); ?>"><?php the_post_thumbnail("full"); ?></a>
                                ...
                                <div class="entry-details">
                                    ...
                                    <div class="entry-date <?php echo esc_attr($tclass); ?>">
                                        ...
                                        <div class="<?php echo esc_attr($show_comment_meta); ?>"><?php
											comments_popup_link('<i class="pe-icon pe-chat"> </i> 0', '<i class="pe-icon pe-chat"> </i> 1', '<i class="pe-icon pe-chat"> </i> %', '', '<i class="pe-icon pe-chat"> </i> <i class="pe-icon pe-close-circle"> </i>'); ?>
                                        </div><!-- comment -->                                         
                                     </div><!-- .entry-date -->


                                	<div class="entry-title">
                                    	<?php if( is_sticky(get_the_id()) ) echo '<span class="sticky-post">'.esc_html__('Featured', 'consultancy').'</span>'; ?>
                                    	<h4><a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s','consultancy'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a></h4>
                                    </div>
                                    
                                    <?php if( $tpl_default_settings['blog-post-excerpt'] == 'true' && $tpl_default_settings['blog-post-excerpt-length'] != '' ):?>
                                    		<div class="entry-body"><?php echo consultancy_excerpt($tpl_default_settings['blog-post-excerpt-length']); ?></div>
                                    <?php endif;?>
                                   ...
                                   <div class="entry-meta-data <?php echo esc_attr($tclass); ?>">
                                   		...
                                   		<p class="author <?php echo esc_attr( $show_author_meta ); ?>">
                                            ...
                                            <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" 
                                            	title="<?php esc_attr_e('View all posts by ', 'consultancy'); echo get_the_author(); ?>"><?php echo get_the_author(); ?></a>
                                        </p>
                        ...
                        <?php elseif( $post_style == "entry-date-author-left"):
                        		...
                        		<div class="entry-date-author <?php echo esc_attr($tclass); ?>">
                                    ...
                                    <div class="entry-author <?php echo esc_attr( $show_author_meta ); ?>">
                                    	...
                                    	<a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" 
                                        	title="<?php esc_attr_e('View all posts by ', 'consultancy'); echo get_the_author(); ?>"><span><?php echo get_the_author(); ?></span></a>
                                    </div>
                        ...
                        <?php else: # Default Post Style ?>
                        		<div class="entry-details">
                                    ...
                                    <div class="entry-meta <?php echo esc_attr($tclass); ?>">
                                    	...
                                    	<div class="date <?php echo esc_attr($show_date_meta); ?>"><?php esc_html_e('Posted on','consultancy'); echo get_the_date(' d M Y'); ?></div>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo consultancy_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
