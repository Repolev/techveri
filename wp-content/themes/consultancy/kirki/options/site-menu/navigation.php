...
# Main menu
	CONSULTANCY_Kirki::add_section( 'dt_site_navigation_section', array(
		'title' => esc_html__( 'Main Menu', 'consultancy' ),
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Menu Active Style', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => 'menu-with-splitter',
			'choices'  => array(
				"menu-default" => esc_attr__( 'Default','consultancy'),
				"menu-active-with-icon menu-active-highlight" => esc_attr__( 'Highlight with Plus Icon','consultancy'),
				"menu-active-highlight" => esc_attr__( 'Highlight','consultancy'),
				"menu-active-highlight-grey" => esc_attr__( 'Highlight Grey','consultancy'),
				"menu-active-highlight-with-arrow" => esc_attr__( 'Highlight with Arrow','consultancy'),
				"menu-active-with-two-border" => esc_attr__( 'Two Border','consultancy'),
				"menu-active-with-double-border" => esc_attr__( 'Double Border','consultancy'),
				"menu-active-border-with-arrow" => esc_attr__( 'Border with Arrow','consultancy'),
				"menu-with-splitter" => esc_attr__( 'Splitter','consultancy'),
			)
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Customize Menu BG ?', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => consultancy_defaults('customize-menu-bg-color'),
			'choices'  => array(
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'section'  => 'dt_site_navigation_section',
			'output' => array(
				array( 'element' => '.menu-wrapper, .dt-menu-toggle, .header-align-left.fullwidth-menu-header .menu-wrapper' , 'property' => 'background-color' )
			),
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Customize Menu Link Colors ?', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => consultancy_defaults('customize-menu-link'),
			'choices'  => array(
				'on'  => esc_attr__( 'Yes', 'consultancy' ),
				'off' => esc_attr__( 'No', 'consultancy' )
			)
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Menu link Color', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Menu link hover Color', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
				array( 'element' => '#main-menu ul.menu > li > a:hover, #main-menu ul.menu li.menu-item-megamenu-parent:hover > a, #main-menu ul.menu > li.menu-item-simple-parent:hover > a,.header-align-left #main-menu ul.menu > li.menu-item-simple-parent:hover > a' , 'property' => 'color' )
			),
			'choices' => array( 'alpha' => true ),
			'active_callback' => array(
				array( 'setting' => 'customize-menu-link', 'operator' => '==', 'value' => '1' ),
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Active Menu Color', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Active Menu BG Color', 'consultancy' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
...
# Sub menu
	CONSULTANCY_Kirki::add_section( 'dt_site_sub_menu_section', array(
		'title' => esc_html__( 'Sub Menu', 'consultancy' ),
		'panel' => 'dt_site_menu_panel',
		'priority' => 2
	) );
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Sub Menu Wrapper Animation', 'consultancy' ),
			'section'  => 'dt_site_sub_menu_section',
			'default'  => '',
			'choices'  => consultancy_animations()
		));
		...
		# customize-sub-menu-wrapper
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Customize Sub Menu Wrapper ?', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'consultancy' ),
					'off' => esc_attr__( 'No', 'consultancy' )
			...
			# Sub Menu Wrapper Background Color
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Custom BG - Sub Menu Wrapper', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'BG Color Type', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'simple',
					'choices'  => array(
						'simple' => esc_html__('Simple','consultancy'),
						'gradient' => esc_html__('Gradient','consultancy')
					),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'BG Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Gradient BG 1', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Gradient BG 1 Stop (in %)', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'	=> 30,
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Gradient BG 2', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
						array( 'element' => '', 'property' => 'background-color')
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Gradient BG 2 Stop (in %)', 'consultancy' ),
					'default'	=> 50,
					'choices'     => array( 'min'  => '0', 'max'  => '100', 'step' => '1' ),
					'section'  => 'dt_site_sub_menu_section',			
					'active_callback' => array(
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Gradient Direction', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'to top',
					'choices'  => array(
						'to top' => esc_html__('Bottom to Top','consultancy'),
						'to bottom' => esc_html__('Top to Bottom','consultancy'),
						'to right' => esc_html__('Left to Right','consultancy'),
						'to left' => esc_html__('Right to Left','consultancy'),
						'to top left' => esc_html__('Bottom Right to Top Left','consultancy'),
						'to top right' => esc_html__('Bottom Left to Right Top','consultancy'),
						'to bottom right' => esc_html__('Left Top to Bottom Right','consultancy'),
						'to bottom left' => esc_html__('Right Top to Bottom Left','consultancy'),
					),			
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-bg-color', 'operator' => '==', 'value' => '1' ),
			...
			# Sub Menu Wrapper Border
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Sub Menu Wrapper Border?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Top Border', 'consultancy' ),
					'description'    => esc_html__( 'sub menu top border value in px', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Right Border', 'consultancy' ),
					'description'    => esc_html__( 'sub menu right border value in px', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Bottom Border', 'consultancy' ),
					'description'    => esc_html__( 'sub menu bottom border value in px', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Left Border', 'consultancy' ),
					'description'    => esc_html__( 'sub menu left border value in px', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Sub-Menu Wrapper Border Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
			...
			# Sub Menu Wrapper Border Radius
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Sub Menu Wrapper Radius?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Top Left Radius', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Top Right Radius', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Bottom Right Radius', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Bottom Left Radius', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
			...
			# Sub Menu Wrapper Box Shadow	
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Sub Menu Wrapper Shadow?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'H Shadow', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'default'  => consultancy_defaults('sub-menu-box-h-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'V Shadow', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => consultancy_defaults('sub-menu-box-v-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Blur Shadow', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => consultancy_defaults('sub-menu-box-blur-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Spread Shadow', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => consultancy_defaults('sub-menu-box-spread-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Shadow Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Box Shadow Inset?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Customize Sub Menu links ?', 'consultancy' ),
			'section'  => 'dt_site_sub_menu_section',
			'choices'  => array(
				'on'  => esc_attr__( 'Yes', 'consultancy' ),
				'off' => esc_attr__( 'No', 'consultancy' )
		...
		# Sub Menu Link BG Settings
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Custom Colors - Sub Menu Links', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'consultancy' ),
					'off' => esc_attr__( 'No', 'consultancy' )
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Sub Menu Link Color', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Sub Menu Link BG Color', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Sub Menu Link Active Color', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Sub Menu Link Active BG Color', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
		...
		# Sub Menu Link Border Style
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Sub Menu Link Border', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'-'	=> esc_html__('None','consultancy'),
					'with-border'	=> esc_html__('With Border','consultancy'),
					'with-hover-border'	=> esc_html__('With Hover Border','consultancy'),
				),
				'active_callback' => array(
					array( 'setting' => 'customize-sub-menu-links', 'operator' => '==', 'value' => '1' )
				)				
				...
				# sub-menu-link-border-style  = with-hover-border
					...
					CONSULTANCY_Kirki::add_field( $config, array(
						...
						'label'    => esc_html__( 'Sub Menu Link Hover Border Style', 'consultancy' ),
						'section'  => 'dt_site_sub_menu_section',
						'default'  => 'solid',
						'choices' => consultancy_border_styles(),
						'output' => array(
					...
					CONSULTANCY_Kirki::add_field( $config, array(
						...
						'label'    => esc_html__( 'Sub Menu Link Hover Border Color', 'consultancy' ),
						'section'  => 'dt_site_sub_menu_section',
						'choices' => array( 'alpha' => true ),
						'output' => array(
				...
				# sub-menu-link-border-style  = with-border
					...
					CONSULTANCY_Kirki::add_field( $config, array(
						...
						'label'    => esc_html__( 'Sub Menu Link Border Style', 'consultancy' ),
						'section'  => 'dt_site_sub_menu_section',
						'default'  => 'solid',
						'choices' => consultancy_border_styles(),
						'output' => array(
					...
					CONSULTANCY_Kirki::add_field( $config, array(
						...
						'label'    => esc_html__( 'Sub Menu Link Border Color ', 'consultancy' ),
						'section'  => 'dt_site_sub_menu_section',
						'choices' => array( 'alpha' => true ),
						'output' => array(
		...
		# Sub Menu Link Border Radius
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Allow Sub Menu Link Radius?', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'consultancy' ),
					'off' => esc_attr__( 'No', 'consultancy' )
		...
		CONSULTANCY_Kirki::add_field( $config, array(
			...
			'label'    => esc_html__( 'Sub Menu Link Icon Style', 'consultancy' ),
			'section'  => 'dt_site_sub_menu_section',
			'default'  => '',
			'choices'  => array(
				''	=> esc_html__('None','consultancy'),
				' menu-links-with-arrow single'	=> esc_html__('Single','consultancy'),
				' menu-links-with-arrow double'	=> esc_html__('Double','consultancy'),
				' menu-links-with-arrow disc'	=> esc_html__('Disc','consultancy'),
			),
			'active_callback' => array(
				array( 'setting' => 'customize-sub-menu-links', 'operator' => '==', 'value' => '1' )
			)				
		...
		# Mega Menu	
			...
			CONSULTANCY_Kirki::add_field( $config, array(
				...
				'label'    => esc_html__( 'Customize Mega Menu title ?', 'consultancy' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'consultancy' ),
					'off' => esc_attr__( 'No', 'consultancy' )
			...
			# Mega Menu Title Color
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Custom Colors - Mega Menu Title', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Mega Menu Title Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'output' => array(
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Mega Menu Title BG Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'output' => array(
			...
			# Mega Menu Title Radius
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Allow Mega Menu Title Radius?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
			...
			# Mega Menu Title Border 
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Apply Mega Menu Title Border?', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'consultancy' ),
						'off' => esc_attr__( 'No', 'consultancy' )
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Mega Menu Title Border Style', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'solid',
					'choices' => consultancy_border_styles(),
					'output' => array(
				...
				CONSULTANCY_Kirki::add_field( $config, array(
					...
					'label'    => esc_html__( 'Mega Menu Title Border Color', 'consultancy' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
