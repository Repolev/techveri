...
CONSULTANCY_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => esc_html__( 'Site Skin', 'consultancy' ),
	'priority' => 23
) );
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Predefined Skin ?', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 1,
		'default'  => consultancy_defaults('use-predefined-skin' ),
		'choices'  => array(
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Skin', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'default' => consultancy_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
		...
		'choices' => array(
			'blue'				=>	esc_attr__('Blue','consultancy'),
			'cyan'				=>	esc_attr__('Cyan','consultancy'),
			'green'				=>	esc_attr__('Green','consultancy'),
			'orange'			=>	esc_attr__('Orange','consultancy'),
			'pink'				=>	esc_attr__('Pink','consultancy'),
			'purple'			=>	esc_attr__('Purple','consultancy'),
			'radient-orchid'	=>	esc_attr__('Radient Orchid','consultancy'),
			'red'				=>	esc_attr__('Red','consultancy'),
			'royal-blue'		=>	esc_attr__('Royal Blue','consultancy'),
			'teal'				=>	esc_attr__('Teal','consultancy')
		)
	));
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Primary Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			# Primary Color - Header
			array( 'element' => '.header-align-left .is-sticky #main-menu ul.menu > li > a, .header-align-left .is-sticky #main-menu > ul.menu > li > .nolink-menu, .header-align-left .is-sticky .menu-icons-wrapper .search a span, .header-align-left .is-sticky .menu-icons-wrapper .cart a span, .header-align-left .is-sticky .menu-icons-wrapper .menu-social-icons .dt-sc-sociable:before', 'property' => 'color' ),

			
			# Primary Color - Blog
			array( 'element' => '.blog-entry .entry-meta a:hover, .blog-entry.entry-date-left .entry-date a:hover, .blog-entry.entry-date-author-left .entry-date-author .comments:hover, .blog-entry.entry-date-author-left .entry-date-author .comments:hover i, .entry-meta-data p a:hover, .blog-entry.entry-date-author-left .entry-date-author .entry-author a:hover, .blog-entry.entry-date-author-left .entry-date-author .comments a:hover, .dt-sc-dark-bg .blog-medium-style.white-highlight .dt-sc-button.fully-rounded-border, .blog-entry.blog-thumb-style .entry-title h4 a:hover, .blog-entry.blog-thumb-style a.read-more:hover, .type2.heading-with-button h5.dt-sc-toggle-accordion.active:before, .type2.heading-with-button h5.dt-sc-toggle.active:before', 'property' => 'color' ),

			# Primary Color - Widgets	
			array( 'element' => '
				.widget #wp-calendar td a:hover, .dt-sc-dark-bg .widget #wp-calendar td a:hover, .secondary-sidebar .widget ul li > a:hover, .dt-sc-practices-list li:before, .secondary-sidebar .type15 .widget.widget_recent_reviews ul li .reviewer, .secondary-sidebar .type15 .widget.widget_top_rated_products ul li .amount.amount, #main-menu .menu-item-widget-area-container .widget ul li > a:hover, #main-menu .dt-sc-dark-bg .menu-item-widget-area-container .widget ul li > a:hover, #main-menu .dt-sc-dark-bg .menu-item-widget-area-container .widget_recent_posts .entry-title h4 a:hover, #main-menu ul li.menu-item-simple-parent.dt-sc-dark-bg ul li a:hover, #main-menu .menu-item-widget-area-container .widget li:hover:before, ul.dt-sc-fancy-list li a:hover, .widget ul li:before', 'property' => 'color' ),
			...
			array( 'element' => '.portfolio .image-overlay .links a:hover, .portfolio.type7 .image-overlay .links a, .project-details li a:hover, .portfolio-categories a:hover, .dt-portfolio-single-slider-wrapper #bx-pager a.active:hover:before, .dt-portfolio-single-slider-wrapper #bx-pager a, .portfolio.type8 .image-overlay .links a, .portfolio-categories a:hover, .portfolio-tags a:hover', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-button.fully-rounded-border, .dt-sc-button.rounded-border, .dt-sc-button.bordered, .dt-sc-button.with-shadow.white, .dt-sc-skin-highlight .dt-sc-button.rounded-border:hover, .dt-sc-skin-highlight .dt-sc-button.bordered:hover, .dt-sc-dark-bg.skin-color .dt-sc-button.fully-rounded-border:hover, .dt-sc-button.filled:hover, .dt-sc-button.no-border-bg, .dt-sc-image-caption.type4:hover .dt-sc-image-content a:hover, .dt-sc-image-caption.type5 .dt-sc-image-content a, .dual-buttons.vc_row.vc_row-no-padding:before, .custom-blog-carousel .slick-list .slick-slide.slick-active .wpb_column .blog-entry .entry-details a.dt-sc-button, .dt-sc-testimonial-wrapper .carousel-arrows a:hover:before', 'property' => 'color' ),

			# Primary Color - Icon Boxes	
			array( 'element' => '.dt-sc-icon-box.type1 .icon-wrapper .icon, .dt-sc-icon-box.type2 .icon-wrapper .icon, .dt-sc-icon-box.type4 .icon-wrapper span, .dt-sc-icon-box.type5:hover .icon-content h4 a, .dt-sc-icon-box.type5.no-icon-bg .icon-wrapper span, .dt-sc-icon-box.type5.no-icon-bg:hover .icon-wrapper span, .dt-sc-icon-box.type10 .icon-wrapper span, .dt-sc-icon-box.type10:hover .icon-content h4, .dt-sc-icon-box.type13 .icon-content h4, .dt-sc-icon-box.type14 .icon-content h4, .dt-sc-icon-box.type5:hover .icon-wrapper span, .dt-sc-icon-box.type3.without-bg .icon-content h5, .dt-sc-icon-box.type3:hover .icon-content h4, a.video-image span:hover', 'property' => 'color' ),

			# Primary Color - Testimonials
			array( 'element' => '.dt-sc-testimonial.type1 blockquote:before, .dt-sc-testimonial.type2 blockquote:after, .dt-sc-testimonial.type4 .dt-sc-testimonial-author cite, .dt-sc-testimonial.type5 .dt-sc-testimonial-author cite, .dt-sc-testimonial.type7 .dt-sc-testimonial-quote blockquote cite, .dt-sc-testimonial.type8 .dt-sc-testimonial-quote blockquote q:before, .dt-sc-testimonial.type8 .dt-sc-testimonial-quote blockquote q:after, .dt-sc-testimonial-special-wrapper:after, .dt-sc-special-testimonial-images-holder .dt-sc-testimonial-image.slick-current .dt-sc-testimonial-author cite, .dt-sc-team-carousel-wrapper .dt-sc-team-details .dt-sc-team-social li a:hover, .dt-sc-image-caption.type9 .dt-sc-image-content h3, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a.current, .dt-sc-team.without-bg .dt-sc-team-details .dt-sc-team-social li a.fa-twitter:hover,
	.dt-sc-team.without-bg .dt-sc-team-details .dt-sc-team-social li a.fa-facebook:hover,
	.dt-sc-team.without-bg .dt-sc-team-details .dt-sc-team-social li a.fa-google-plus:hover,
	.dt-sc-team.without-bg .dt-sc-team-details .dt-sc-team-social li a.fa-linkedin:hover', 'property' => 'color' ),

			# Primary Color - Horizontal Tabs	
			array( 'element' => 'ul.dt-sc-tabs-horizontal-frame > li > a.current, ul.dt-sc-tabs-horizontal > li > a.current, ul.dt-sc-tabs-horizontal > li > a:hover, ul.dt-sc-tabs-horizontal-frame > li > a:hover, .type7 ul.dt-sc-tabs-horizontal-frame > li > a.current, .dt-sc-tabs-horizontal-frame-container.type5 ul.dt-sc-tabs-horizontal-frame > li > a.current', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-title.with-sub-title h3, .dt-sc-title.script-with-sub-title strong, .dt-sc-title.with-two-color-stripe h2, .dt-sc-hexagon-title h2 span, h1 strong, h2 strong, h3 strong, h4 strong, h5 strong, h6 strong', 'property' => 'color' ),

			# Primary Color - Image Caption	
			array( 'element' => '.dt-sc-image-with-caption h3 a, .dt-sc-image-caption.type3 .dt-sc-image-content h3, .dt-sc-image-caption.type4:hover .dt-sc-image-content h3, .dt-sc-event-image-caption .dt-sc-image-content h3, .dt-sc-image-caption.type8:hover .dt-sc-image-content h3 a:hover, .dt-sc-image-caption.type3 .dt-sc-image-wrapper .icon-wrapper span, .dt-sc-image-caption.type4 .dt-sc-image-content h3', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-counter.type3.diamond-square h4, .dt-sc-counter.type6:hover h4, .dt-sc-counter.type2 .icon-wrapper span.zmdi, .dt-sc-counter.type2 .icon-wrapper span.pe-icon, .dt-sc-counter.type2 .icon-wrapper span.icon, .dt-sc-counter.type2 .icon-wrapper span.fa, .dt-sc-counter.type2 .dt-sc-counter-number', 'property' => 'color' ),
			...
			array( 'element' => '.left-header #toggle-sidebar, .left-header-footer, .overlay-header #trigger-overlay, .overlay .overlay-close, 
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-menu-toggle, .two-color-header .main-header-wrapper:before, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(odd) > a, #main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(odd) > .nolink-menu', 'property' => 'background-color' ),
			...
			array( 'element' => '
				.entry-format a, .blog-entry.blog-medium-style:hover .entry-format a,  .blog-entry.blog-medium-style.dt-blog-medium-highlight.dt-sc-skin-highlight, .blog-entry.blog-medium-style.dt-blog-medium-highlight.dt-sc-skin-highlight .entry-format a, ul.commentlist li .reply a:hover, .dt-sc-dark-bg .blog-medium-style.white-highlight .dt-sc-button.fully-rounded-border:hover, .post-nav-container .post-next-link a, .post-nav-container .post-prev-link a, .page-link > span, .page-link a:hover, .post-edit-link:hover, .vc_inline-link:hover, .pagination ul li a:hover, .pagination ul li span, .custom-blog-carousel .slick-list .slick-slide.slick-active .blog-entry, .dt-carousel-pagination a.selected, .custom-dot-navigation ul.slick-dots li.slick-active i, .custom-dot-navigation ul.slick-dots li i:hover', 'property' => 'background-color' ),			
...
.dt-sc-icon-box.type5.no-icon:hover .icon-content h4:before, .dt-sc-icon-box.type3 .icon-content h4:before', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-image-caption.type4:hover .dt-sc-button, .dt-sc-image-caption.type4 .dt-sc-image-content h3:after, .dt-sc-image-caption.type8 .dt-sc-image-content, .dt-sc-image-caption.type7 .dt-sc-image-content h3:after, .dt-sc-image-caption.type7:hover .dt-sc-image-wrapper, .dt-sc-image-caption.type8 .dt-sc-image-content:before, .dt-sc-event-image-caption:hover, .dt-sc-image-caption.type3:hover, .dt-sc-image-caption.type3:hover .dt-sc-image-wrapper .icon-wrapper:after, .dt-sc-image-caption.with-separator .dt-sc-image-title:after', 'property' => 'background-color' ),	

			# Primary BG Color - Horizontal Tabs
			array( 'element' => '.dt-sc-tabs-horizontal-frame-container.type4 ul.dt-sc-tabs-horizontal-frame > li > a.current > span:after, .dt-sc-tabs-horizontal-frame-container.type6 ul.dt-sc-tabs-horizontal-frame > li > a, .type8 ul.dt-sc-tabs-horizontal-frame > li > a.current, .type8 ul.dt-sc-tabs-horizontal-frame > li > a:hover', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-toggle-frame h5.dt-sc-toggle-accordion.active a:before, h5.dt-sc-toggle-accordion.active a:before, .dt-sc-toggle-frame h5.dt-sc-toggle.active a:before, h5.dt-sc-toggle.active a:before, .type2 .dt-sc-toggle-frame h5.dt-sc-toggle-accordion.active, .type2 .dt-sc-toggle-frame h5.dt-sc-toggle.active, .dt-sc-toggle-frame-set.type2 > h5.dt-sc-toggle-accordion.active:after, .dt-sc-toggle-icon, h5.dt-sc-toggle.active:after, h5.dt-sc-toggle-accordion.active:after', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-colored-big-buttons, .dt-sc-button.fully-rounded-border, .dt-sc-button.fully-rounded-border:hover, .dt-sc-button.rounded-border.black:hover, .dt-sc-button.bordered.black:hover, .dt-sc-button.bordered:hover, .dt-sc-button.rounded-border:hover, .dt-sc-button.filled', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-counter.type2:hover .icon-wrapper span.zmdi:after, .dt-sc-counter.type2:hover .icon-wrapper span.pe-icon:after, .dt-sc-counter.type2:hover .icon-wrapper span.icon:after, .dt-sc-counter.type2:hover .icon-wrapper span.fa:after, .dt-sc-counter.type3 .icon-wrapper:before, .dt-sc-counter.type3.diamond-square, .dt-sc-counter.type5:hover:before, .dt-sc-counter.type5:hover:after, .dt-sc-counter.type6, .dt-sc-counter.type6 .dt-sc-couter-icon-holder:before', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-icon-box.type5.no-icon .icon-content h4, .dt-sc-icon-box.type5.no-icon, .dt-sc-icon-box.type10, .dt-sc-icon-box.type10 .icon-wrapper:before, .dt-sc-icon-box.type3.dt-sc-diamond:hover .icon-wrapper:after, .dt-sc-icon-box.type11:before, .dt-sc-icon-box.type3 .icon-wrapper span:after', 'property' => 'border-color' ),
			...
			array( 'element' => '
				...
				.dt-sc-dark-bg .widget.tribe_mini_calendar_widget .tribe-mini-calendar .tribe-events-present, .dt-sc-dark-bg .widget.tribe_mini_calendar_widget .tribe-mini-calendar .tribe-events-has-events.tribe-mini-calendar-today, .dt-sc-dark-bg .tribe-mini-calendar .tribe-events-has-events.tribe-events-present a:hover, .dt-sc-dark-bg .widget.tribe_mini_calendar_widget .tribe-mini-calendar td.tribe-events-has-events.tribe-mini-calendar-today a:hover, .custom-arrow-navigation .slick-slider button:hover', 'property' => 'background-color' ),
			...
			array( 'element' => '.woo-type10 ul.products li.product:hover .product-details:before, .woo-type10 ul.products li.product:hover .product-details:after', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-attorney-sorting a.active-sort, .dt-sc-attorneys-single h5.dt-sc-attorney-role:before, .dt-sc-attorneys-single h5.dt-sc-attorney-role:after, .dt-sc-attorney .dt-sc-attorney-details h5:before, .dt-sc-attorney .dt-sc-attorney-details h5:after, .widget.widget_attroney .widgettitle:after, .attorney-contact-form-widget input[type="submit"]:hover, .dt-sc-practices-list li a:hover, .dt-sc-attorney-location-overlay p:last-child a', 'property' => 'background-color' ),
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Secondary Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Tertiary Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			...
			array( 'element' => '
				...
				#main-menu .megamenu-child-container.dt-sc-dark-bg > ul.sub-menu > li > a:hover, #main-menu .megamenu-child-container.dt-sc-dark-bg ul.sub-menu > li > ul li a:hover, #main-menu .megamenu-child-container.dt-sc-dark-bg ul.sub-menu > li > ul li a:hover .fa', 'property' => 'color' ),

			# Tertiary Color - Menu - Left Header
			...
			array( 'element' => '.dt-sc-faculty-sorting a:hover, .dt-sc-faculty-sorting a.active-sort, .dt-sc-course .dt-sc-course-details .dt-sc-course-meta p span, .dt-sc-course.no-course-thumb .dt-sc-course-details h5 a, #footer .dt-sc-dark-bg a:hover', 'property' => 'color' ),
	...
	# quaternary-default-color
	CONSULTANCY_Kirki::add_field( $config, array(
		'type' => 'color',
		'settings' => 'quaternary-default-color',
		'label'    => esc_html__( 'Quaternary Default Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 6,
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('quaternary-default-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			array( 'element' => '.has-quaternary-background-color', 'property' => 'background-color' ),
			array( 'element' => '.has-quaternary-color', 'property' => 'color' ),
		
			# Quaternary BG Color - Shortcodes, Custom Work
			array( 'element' => '.secondary-transparent-bg:before, .vc_parallax.secondary-skin-bg.transparent:before, .secondary-skin-highlight, .secondary-skin-bg, .dt-sc-title.with-right-border-decor > *:first-child:after, .secondary-skin.dt-sc-button.filled, .secondary-skin.dt-sc-button.rounded-corner, .dt-carousel-pagination a, .custom-dot-navigation ul.slick-dots li i, .dt-sc-counter.type1 .dt-sc-counter-number:before, .wpcf7 input[type="submit"], .wpcf7 button, .wpcf7 input[type="reset"], .dt-sc-contact-info.type4 h6:after, .dt-sc-contact-info.type4 span:after, .widgettitle:after, .widget:hover .widgettitle:before, #footer .footer-copyright .menu-links li a:before, .dt-sc-counter.type1:hover .icon-wrapper span.fa:after, .dt-sc-counter.type1:hover .icon-wrapper span.zmdi:after, .dt-sc-counter.type1:hover .icon-wrapper span.icon-moon:after, .dt-sc-counter.type1:hover .icon-wrapper span.pe-icon:after, .dt-sc-counter.type1:hover .icon-wrapper span.icon:after, .dt-sc-image-caption.type4:hover .dt-sc-button.transparent, .dt-sc-icon-box.type1 .icon-content h4:after, .custom-navigation .vc_images_carousel .vc_carousel-indicators li.vc_active, .custom-navigation .vc_images_carousel .vc_carousel-indicators li:hover, .custom-navigation .vc_images_carousel .vc_carousel-control:hover, .dt-sc-testimonial.type5 .dt-sc-testimonial-author cite, .dt-sc-testimonial-special-wrapper:before, .section40 .aio-icon-component.style_2:hover, .university-contact-form .button-field input[type="submit"], .section44 .dt-sc-team .dt-sc-team-details,
	.custom-tabs ul.dt-sc-tabs-horizontal > li > a.current span, .dt-sc-doctors-single-meta li ul.child-bullet-list li:before, .dt-sc-doctors.style1 .dt-sc-doctors-thumb-wrapper .dt-sc-button:hover, .dt-sc-doctors.style1 .dt-sc-doctors-details ul.dt-sc-sociable li a:hover, .dt-sc-doctors.style1 .dt-sc-doctors-single-meta li span, .dt-sc-team.style2 .dt-sc-sociable li a:hover, .dt-sc-team.style2 .dt-sc-team-details .view-details, .dt-sc-team-carousel .dt-sc-team-details, .dt-sc-doctors-single .dt-sc-doctors.style1 .dt-sc-doctors-details ul.dt-sc-sociable li a:hover, .dt-sc-procedure-item .details .view, .dt-sc-procedure-item .details h3:before, .dt-sc-fitness-procedure-sorting a:hover,.dt-sc-fitness-procedure-sorting a.active-sort, .dt-sc-popular-procedures .details h5, ul.time-table > li:hover, .dt-sc-reservation-form.dt-appointment-form .dt-sc-button.show-time-shortcode, .dt-sc-schedule-progress.dt-sc-current-step .dt-sc-progress-step span, .dt-sc-available-times ul.time-slots:hover, #main-menu ul li.menu-item-simple-parent ul > li > a:after, #main-menu .menu-item-megamenu-parent .megamenu-child-container ul.sub-menu > li > ul > li > a:after,
	#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(even) > a, 
#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(even) > .nolink-menu, .dt-sc-image-caption.type8:hover .dt-sc-image-content, .dt-sc-icon-box.type5:hover .icon-wrapper, .secondary-skin-bg, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a, .custom-blog-carousel .slick-list .slick-slide.slick-active .wpb_column .blog-entry .entry-details a.dt-sc-button', 'property' => 'background-color' ),	

			# Quaternary Color - Shortcodes, Custom Work
			array( 'element' => '.secondary-skin-color, .secondary-skin.dt-sc-button.bordered, .secondary-skin.dt-sc-button.bordered, .secondary-skin.dt-sc-button.rounded-border, .secondary-skin.dt-sc-button.fully-rounded-border, .dt-sc-icon-box.type2 .icon-content i, .dt-sc-contact-info span, .dt-sc-icon-box.type4 .icon-wrapper span, ul.dt-sc-fancy-list li:before, .dt-sc-contact-info.type4 a, #footer .widget ul li:before, #footer .footer-copyright .menu-links li a:hover, .dt-sc-special-testimonial-details-holder .dt-sc-testimonial-description:before, .dt-sc-special-testimonial-images-holder .dt-sc-testimonial-author cite, .blog-entry.blog-thumb-style .entry-title h4 a, .dt-sc-icon-box.type1 .icon-wrapper span, .university-contact-info p a, #footer a:hover, .breadcrumb a:hover, .dt-sc-title.script-with-sub-title.secondary-skin strong, .dt-sc-team.simple-rounded:hover .dt-sc-team-social li a:hover, .secondary-skin h1 strong, .secondary-skin h2 strong, .secondary-skin h3 strong, .secondary-skin h4 strong, .secondary-skin h5 strong, .secondary-skin h6 strong, .secondary-skin.dt-sc-button.bordered:hover, .custom-arrow-navigation.icon-bottom-alignment .dt-sc-image-caption:hover .dt-sc-image-title h3', 'property' => 'color' ),

			# Quaternary Border Color - Shortcodes, Custom Work
			array( 'element' => '.secondary-skin.dt-sc-button.bordered, .secondary-skin.dt-sc-button.rounded-border, .secondary-skin.dt-sc-button.fully-rounded-border, .dt-sc-image-caption.type4:hover .dt-sc-image-content, .dt-sc-counter.type1:hover .icon-wrapper span.fa:after, .dt-sc-counter.type1:hover .icon-wrapper span.zmdi:after, .dt-sc-counter.type1:hover .icon-wrapper span.icon-moon:after, .dt-sc-counter.type1:hover .icon-wrapper span.pe-icon:after, .dt-sc-counter.type1:hover .icon-wrapper span.icon:after, .dt-sc-icon-box.type2:hover .icon-content, .dt-sc-icon-box.type2:hover .icon-content h4, .dt-sc-icon-box.type1 .icon-content h4:before, .dt-sc-testimonial.type5 .dt-sc-testimonial-quote, .dt-sc-team-navigation .dt-sc-team-pager-prev:hover:before, .dt-sc-team-navigation .dt-sc-team-pager-next:hover:before, .dt-sc-schedule-progress.dt-sc-current-step, h5.dt-sc-toggle-accordion.active a, h5.dt-sc-toggle.active a, .secondary-skin.dt-sc-button.bordered', 'property' => 'border-color' ),

			# Quaternary Border Right Color - Shortcodes, Custom Work
			array( 'element' => '.custom-arrow-navigation .slick-slider button.slick-prev i:before, .dt-sc-special-testimonial-images-holder.slick-slider button.slick-prev:before, .dt-sc-partners-carousel-wrapper .carousel-arrows a.partners-prev:before, .consulting-hours:before', 'property' => 'border-right-color' ),

			# Quaternary Border Left Color - Shortcodes, Custom Work
			array( 'element' => '.custom-arrow-navigation .slick-slider button.slick-next i:before, .dt-sc-special-testimonial-images-holder.slick-slider button.slick-next:before, .dt-sc-partners-carousel-wrapper .carousel-arrows a.partners-next:before', 'property' => 'border-left-color' ),

			# Quaternary Border Top Color - Shortcodes, Custom Work
			array( 'element' => '#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(even):hover > a:after, 
	#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li:nth-child(even):hover > .nolink-menu:after,
	#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li.current-menu-ancestor:nth-child(even) > a:after, 
	#main-menu .menu-item-megamenu-parent .megamenu-child-container > ul.sub-menu > li.current-menu-ancestor:nth-child(even) > .nolink-menu:after, .dt-sc-loading:before, .dt-sc-tabs-horizontal-frame-container.type3.alter ul.dt-sc-tabs-horizontal-frame > li > a', 'property' => 'border-top-color' ),
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site BG Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 
		...
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('body-bg-color'),
	));
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Content Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('body-content-color'),
	));
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Link Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('body-a-color'),
	));
	...
	CONSULTANCY_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Link Hover Color', 'consultancy' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => consultancy_defaults('body-a-hover-color'),
	));					