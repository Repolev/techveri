...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_classes); ?>>
	<?php if( array_key_exists('show-featured-image', $post_meta) && ( $post_meta['show-featured-image'] == true ) ):?>
			<!-- Featured Image -->
	...
	<?php if( $post_style == "entry-date-left"):?>
			...
			<div class="entry-details">
				...
				<?php edit_post_link( esc_html__( ' Edit ','consultancy' ) ); ?>
			</div><!-- .entry-details -->
			...
			<div class="entry-details">
				...
				<div class="entry-meta">
					...
					<div class="author <?php echo esc_attr( $show_author_meta ); ?>">
						/ <i class="pe-icon pe-user"> </i>
						<a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" title="<?php esc_attr_e('View all posts by ', 'consultancy'); echo get_the_author(); ?>">
...
<?php # Post Author Information Box
	...
	if( !empty($post_author_box) ):?>
		...
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','consultancy'); ?></h2>
			<div class="thumb">
