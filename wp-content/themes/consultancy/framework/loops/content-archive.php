<?php
	...
	if( have_posts() ) :
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                   ...
                                   <?php if( !empty($allow_excerpt) && !empty($excerpt) ):?>
                                    		<div class="entry-body"><?php echo consultancy_excerpt($excerpt); ?></div>
                                   <?php endif;?>
                                   ...
                                   <!-- Read More Button -->
                                   <?php if( !empty($allow_read_more) && !empty($read_more) ):
								   			if( shortcode_exists( 'dt_sc_button' ) && class_exists( 'Vc_Manager' ) ):
												$read_more = stripcslashes($read_more);
												$sc = str_replace("]",' link="url:'.$link.'"]',$read_more);
												$sc = do_shortcode($sc);
												echo !empty( $sc ) ? $sc : '';
											else:
												echo '<a href="'.get_permalink().'" title="'.get_the_title().'" class="dt-sc-button small icon-right with-icon no-border-bg">'.esc_html__('Read More', 'consultancy').'<span class="fa fa-long-arrow-right"> </span></a>';
											endif;
                        ...
                        <?php else: # Default Post Style ?>
                        		<div class="entry-details">
                                    ...
                                    <div class="entry-meta">
                                    	...
                                    	<div class="date <?php echo esc_attr($show_date_meta); ?>"><?php esc_html_e('Posted on','consultancy'); ?>  <?php echo get_the_date ( get_option('date_format') ); ?></div>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo consultancy_pagination(); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends --><?php

	else:?>
    	<h2><?php esc_html_e('Nothing Found.', 'consultancy'); ?></h2>
        <p><?php esc_html_e('Apologies, but no results were found for the requested archive.', 'consultancy'); ?></p><?php
	endif;?>