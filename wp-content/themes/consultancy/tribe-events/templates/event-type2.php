	...
	<div class="container">
        ...
        <div class="dt-sc-one-half column ver-sep">
            ...
            if(class_exists( 'Tribe__Events__Pro__Main' )): ?>
                <a href="#" class="dt-sc-tooltip-top" title="<?php echo tribe_get_recurrence_text ( $event_id ); ?>"><?php esc_html_e('Recurring Event (See all)', 'consultancy'); ?></a><?php
            endif; ?>
        </div>
        <div class="dt-sc-one-fourth column right-calc">
            <a href="<?php echo esc_url( tribe_get_gcal_link($event_id) ); ?>"><?php esc_html_e('+ Google Calendar', 'consultancy'); ?></a><br />
            <a href="<?php echo esc_url( tribe_get_ical_link() ); ?>"><?php esc_html_e('+ iCal Export', 'consultancy'); ?></a>
        </div>
	</div>        
    	...
    	<div class="container">
            <div class="dt-sc-one-third column first">
                <div class="event-details">
                    ...
                    <ul>
                        <li><dt><?php esc_html_e('Start:', 'consultancy'); ?></dt><?php echo tribe_get_start_date ( $event_id, true, 'M d' ).' @ '.tribe_get_start_time ( $event_id, 'h:i a' ); ?></li>
                        <li><dt><?php esc_html_e('End:', 'consultancy'); ?></dt><?php echo tribe_get_end_date ( $event_id, true, 'M d' ).' @ '.tribe_get_end_time ( $event_id, 'h:i a' ); ?></li>
            ...
            <div class="dt-sc-one-third column">
                <div class="event-organize">
                    ...
                    <ul><?php
                        ...
                        if(!empty($email)): ?>
                            <li><dt><?php esc_html_e('Email:', 'consultancy'); ?></dt><a href="mailto:<?php echo esc_attr($email); ?>"><?php echo apply_filters( 'tribe_get_organizer_email', $email); ?></a></li><?php
                        endif;
            ...
            <div class="dt-sc-one-third column">
                <div class="event-venue">
                    <h3><?php esc_html_e('Venue', 'consultancy'); ?></h3>
                    <ul><?php
                        if(tribe_address_exists()): ?>
                            <li><dt><?php esc_html_e('Address:', 'consultancy'); ?></dt>
